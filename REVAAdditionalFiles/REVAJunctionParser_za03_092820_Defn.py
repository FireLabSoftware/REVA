...
while ai1<len(argv):
    ...
    if a11.startswith('ignore'):
        ...
        BarcodeList1=open(a22,mode='r').read().splitlines()
...
if not(FL1):
    ...
    raise(SystemError)
FGood1 = open('GoodJunctions_'+MetaName1[0]+now1+'.tdv', mode='w')
FBad1 = open('QuestionableJunctions_'+MetaName1[0]+now1+'.tdv', mode='w')
def antisense(s):
...
FGood1.close()
FBad1.close()
MetaOut1 = open('AggregateJunctionSummary_'+MetaName1+now1+'.tdv',mode='w')
...
for Index1 in sorted(MetaD1.keys()):
    ...
    if Index1[0][0]==Index1[1][0]:
        ...
        if Sense0 and Sense1:
            Mnemonic1 = 'TrnSS'+str(del1)
        elif Sense0 and not(Sense1):
            Mnemonic1 = 'TrnSA'+str(del1)
        elif not(Sense0) and Sense1:
            Mnemonic1 = 'TrnAS'+str(del1)
        elif not(Sense0) and not(Sense1):
            Mnemonic1 = 'TrnAA'+str(del1)
